...
var ObjectValidator = /** @class */ (function (_super) {
    ...
    function ObjectValidator() {
        ...
        _this.requiredProps = [];
        _this.keyValidators = {};
        _this.addRule('object', function (value, obj, path, context) { return __awaiter(_this, void 0, void 0, function () {
    ...
    ObjectValidator.prototype.requiresIfAny = function (conditionalProps, validationRules) {
        ...
        conditionalProperties.forEach(function (conditionalProperty) {
            _this.addRule('requiresIfAny', function (value, obj, path, context) { return __awaiter(_this, void 0, void 0, function () {
    ...
    ObjectValidator.prototype.requiresWithAny = function (conditionalProps, assertionPaths) {
        ...
        conditionalProperties.forEach(function (conditionalProperty) {
            _this.addRule('requiresWithAny', function (value, obj, path, context) { return __awaiter(_this, void 0, void 0, function () {
                var i;
                return __generator(this, function (_a) {
    ...
    ObjectValidator.prototype.requiresWithAll = function (conditionalProps, assertionProps) {
        ...
        conditionalProperties.forEach(function (conditionalProperty) {
            _this.addRule('requiresWithAll', function (value, obj, path, context) { return __awaiter(_this, void 0, void 0, function () {
                var i;
                return __generator(this, function (_a) {
                    for (i = 0; i < assertionProperties.length; i++) {
                        if (!json_pointer_1.has(obj, assertionProperties[i]))
    ...
    ObjectValidator.prototype.getKeyRules = function (name) {
