...
exports.emailPattern = exports.urlPattern = void 0;
...
exports.default = {
    ...
    confirmed: function () { return function (value, obj, path) {
        var confirmPath = "".concat(path, "_confirmation");
        return ((0, json_pointer_1.has)(obj, path) && (0, json_pointer_1.has)(obj, confirmPath) && (0, json_pointer_1.get)(obj, path) === (0, json_pointer_1.get)(obj, confirmPath));
    }; },
};
