...
var NumberValidator = /** @class */ (function (_super) {
    ...
    function NumberValidator(integer) {
        if (integer === void 0) { integer = false; }
        var _this = _super.call(this) || this;
        // attaching type validator
        _this.addValidator((integer) ? 'integer' : 'number', function (value, obj, path, context) { return __awaiter(_this, void 0, void 0, function () {
    ...
    NumberValidator.prototype.min = function (min, exclusive) {
        ...
        this.addValidator('min', function (value, obj, path, context) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!rules_1.number.min(min, exclusive)(value))
                    context.addError('number.min', path, { limit: min, exclusive: exclusive });
                return [2 /*return*/];
            });
        }); });
        return this;
    ...
    NumberValidator.prototype.max = function (max, exclusive) {
        var _this = this;
        if (exclusive === void 0) { exclusive = false; }
        this.addValidator('max', function (value, obj, path, context) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!rules_1.number.max(max, exclusive)(value))
                    context.addError('number.max', path, { limit: max, exclusive: exclusive });
                return [2 /*return*/];
            });
        }); });
        return this;
    ...
    NumberValidator.prototype.multipleOf = function (modulus) {
        var _this = this;
        this.addValidator('multipleOf', function (value, obj, path, context) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!rules_1.number.multipleOf(modulus)(value))
                    context.addError('number.multipleOf', path, { modulus: modulus });
                return [2 /*return*/];
            });
        }); });
        return this;
