...
var ObjectValidator = /** @class */ (function (_super) {
    ...
    ObjectValidator.prototype.addTypeValidator = function (name, validator) {
        var pointer = "/" + name;
    ...
    ObjectValidator.prototype.array = function (name) {
        return this.addTypeValidator(name, new _1.ArrayValidator(getPath(name), this));
    };
    ...
    ObjectValidator.prototype.string = function (name) {
        return this.addTypeValidator(name, new _1.StringValidator(this));
    };
    ObjectValidator.prototype.date = function (name, format) {
        if (format === void 0) { format = intefaces_1.DF.ISO8601; }
        return this.addTypeValidator(name, new _1.DateValidator(format, this));
    };
    ObjectValidator.prototype.number = function (name, integer) {
        if (integer === void 0) { integer = false; }
        return this.addTypeValidator(name, new _1.NumberValidator(this, integer));
    };
    ObjectValidator.prototype.boolean = function (name) {
        return this.addTypeValidator(name, new _1.BooleanValidator(this));
    };
    ...
    ObjectValidator.prototype.validate = function (value, path) {
        ...
        Object.keys(this.typeValidators).forEach(function (propertyName) {
            ...
            var propertyResult = _this.typeValidators[propertyName]
                .validate(value, path);
