...
exports.BaseTypeValidator = void 0;
...
var BaseTypeValidator = /** @class */ (function () {
     ...
     * */
    BaseTypeValidator.prototype.attach = function (func, name) {
        name = name ? name : func.name;
        this.addRule({ name: name, func: func });
        return this;
    };
    BaseTypeValidator.prototype.clone = function () {
        return cloneDeep(this);
    };
    /**
     * adds a new validator to the validators set
     * */
    BaseTypeValidator.prototype.addRule = function (rule) {
     ...
     * @param name the name of validation rule
     * */
    BaseTypeValidator.prototype.removeRule = function (name) {
     ...
     * @param name the name of validation rule
     * */
    BaseTypeValidator.prototype.hasRule = function (name) {
        ...
        this.addRule({
            ...
            func: function (value, obj, path, context) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (!items.find(function (item) { return isEqual(value, item); })) {
    ...
    BaseTypeValidator.prototype.on = function (path) {
        ...
        this.addRule({
            name: 'on',
            func: function (value, obj, dataPath, context) { return __awaiter(_this, void 0, void 0, function () {
                var container;
                return __generator(this, function (_a) {
                    if ((0, json_pointer_1.has)(obj, path)) {
                        container = (0, json_pointer_1.get)(obj, path);
                        if (!Array.isArray(container) || !container.find(function (conValue) { return isEqual(value, conValue); })) {
    ...
    BaseTypeValidator.prototype.validate = function (obj, context, path) {
        ...
        var targetValue = (0, json_pointer_1.get)(obj, path);
