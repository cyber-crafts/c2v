...
var NumberValidator = /** @class */ (function (_super) {
        ...
        this.addValidator(function (value, obj, path, context) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!rules_1.number.min(min, exclusive)(value))
                    context.addError('number.min', path, { exclusive: exclusive });
                return [2 /*return*/];
            });
        }); });
        return this;
        ...
        this.addValidator(function (value, obj, path, context) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!rules_1.number.max(max, exclusive)(value))
                    context.addError('number.max', path, { exclusive: exclusive });
                return [2 /*return*/];
            });
        }); });
        return this;
    ...
    NumberValidator.prototype.multipleOf = function (modulus) {
        ...
        this.addValidator(function (value, obj, path, context) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!rules_1.number.multipleOf(modulus))
