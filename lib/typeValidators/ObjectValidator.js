...
var ObjectValidator = /** @class */ (function (_super) {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                if (!(0, json_pointer_1.has)(conditionalObject, (0, utils_1.sanitizePath)(wrapper.path))) return [3 /*break*/, 3];
                                _context = new Context_1.default().setData(context.getData());
                                return [4 /*yield*/, Promise.all(wrapper.validator.validate(conditionalObject, _context, (0, utils_1.sanitizePath)(wrapper.path)))
                            ...
                            case 2:
                                ...
                                // if context is clean then the `conditionalProperty` should exist
                                if (_context.isValid)
                                    if (!(0, json_pointer_1.has)(value, "/".concat(conditionalProperty))) {
                                        errorParams = {
                ...
                func: function (value, obj, path, context) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        for (i = 0; i < assertionProperties.length; i++)
                            if ((0, json_pointer_1.has)(obj, assertionProperties[i]))
    ...
    ObjectValidator.prototype.validate = function (obj, context, path) {
        ...
        this.requiredProps.forEach(function (property) {
            if (!(0, json_pointer_1.has)(clone, "".concat(path, "/").concat(property)) || (0, json_pointer_1.get)(clone, "".concat(path, "/").concat(property)) === null) {
        ...
        Object.keys(this.keyValidators).forEach(function (propertyName) {
            ...
            if ((0, json_pointer_1.has)(obj, propertyPath) && (0, json_pointer_1.get)(obj, propertyPath) !== null) {
