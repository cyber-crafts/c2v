...
var DateValidator = /** @class */ (function (_super) {
    ...
    DateValidator.prototype.parse = function (date) {
        if (typeof date === 'number' && this._format === contracts_1.DF.Unix)
            return moment_1.default.unix(date);
        return (0, moment_1.default)(date, this._format);
    };
    ...
    DateValidator.prototype.validate = function (obj, context, path) {
        if (path === void 0) { path = ''; }
        obj = (0, lodash_clonedeep_1.default)(obj);
        if (path !== '') {
            (0, json_pointer_1.set)(obj, path, this.parse((0, json_pointer_1.get)(obj, path)));
