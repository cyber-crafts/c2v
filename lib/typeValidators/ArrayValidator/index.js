...
var ArrayValidator = /** @class */ (function (_super) {
    ...
    ArrayValidator.prototype.minItems = function (limit) {
        var _this = this;
        this.addRule('minItems', function (value, obj, path, context) { return __awaiter(_this, void 0, void 0, function () {
    ...
    ArrayValidator.prototype.maxItems = function (limit) {
        var _this = this;
        this.addRule('maxItems', function (value, obj, path, context) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (value.length > limit)
