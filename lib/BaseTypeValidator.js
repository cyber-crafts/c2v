...
var BaseTypeValidator = /** @class */ (function () {
     ...
     * @param validator {IValidationRule} the rule name
     * */
    BaseTypeValidator.prototype.addRule = function (name, validator) {
    ...
    BaseTypeValidator.prototype.in = function () {
        ...
        this.addRule('in', function (value, obj, path, context) { return __awaiter(_this, void 0, void 0, function () {
    ...
    BaseTypeValidator.prototype.on = function (path) {
        var _this = this;
        this.addRule('on', function (value, obj, dataPath, context) { return __awaiter(_this, void 0, void 0, function () {
            var container;
            return __generator(this, function (_a) {
